...
class Question(models.Model):
	tossup_or_bonus = models.CharField(max_length=200,default=None, blank=True, null=True)
	...
	x = models.CharField(max_length=500, default=None, blank=True, null=True)
	y = models.CharField(max_length=500, default=None, blank=True, null=True)
	z = models.CharField(max_length=500, default=None, blank=True, null=True)
	correct = models.CharField(max_length=500, default=None, blank=True, null=True)
